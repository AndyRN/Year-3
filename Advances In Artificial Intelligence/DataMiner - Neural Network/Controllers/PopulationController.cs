...
namespace DataMiner.Controllers
{
    public class PopulationController
    {
        ...
        {
            int worstFitness = population.Min(x => x.Fitness);
            Individual worstSolution = population.Where(x => x.Fitness == worstFitness).FirstOrDefault();

            worstSolution.Fitness = bestSolution.Fitness;
            worstSolution.Chromosome = bestSolution.Chromosome;
        ...
        public  List<Individual> AdjustWeights(List<Individual> population)
        {
